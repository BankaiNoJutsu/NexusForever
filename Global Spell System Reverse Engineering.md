...
| `ItemVisualSwap` | 1,542 | Applies immediate visual slot/display swaps through existing entity visual update packets; duration-backed rows are traced until previous-visual restoration is tracked. |
