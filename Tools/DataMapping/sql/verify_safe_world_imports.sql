...
UNION ALL SELECT 'northern_wilds_static_avalanche_rows', COUNT(*) FROM entity WHERE world = 426 AND creature IN (15615, 67662)
UNION ALL SELECT 'expected_northern_wilds_static_avalanche_rows_0_mismatch', IF(COUNT(*) = 0, 0, 1) FROM entity WHERE world = 426 AND creature IN (15615, 67662)
