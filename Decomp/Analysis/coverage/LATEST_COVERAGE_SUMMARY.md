...
| --- | --- | --- | --- |
| `Server0x0015` | 0x0015 | `Server0x0015` | native 140081f00 reads one 5-bit field plus one uint32; shared with matching opcode 0x0628 and Fortune reward rows, so semantics remain unresolved |
