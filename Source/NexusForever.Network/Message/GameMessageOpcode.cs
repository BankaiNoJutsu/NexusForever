namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        Server0x025F                    = 0x025F, // 0x2C-byte payload; semantics unresolved
        Server0x0260                    = 0x0260, // 0x10-byte payload; semantics unresolved
        Server0x0261                    = 0x0261, // 0x10-byte payload; semantics unresolved
        ServerEntityCreate              = 0x0262,
        Server0x0263                    = 0x0263, // 0x24-byte payload; semantics unresolved
        Server0x0264                    = 0x0264, // 0x18-byte payload; semantics unresolved
        ...
        Server0x0889                    = 0x0889, // 0xC-byte payload; semantics unresolved
        ...
        Server0x08CC                    = 0x08CC, // 0x10-byte payload; semantics unresolved
        ServerUnitSetChair              = 0x08CF,
        ServerReputationOverrideAdd     = 0x08D7,
        Server0x08F4                    = 0x08F4, // 0xC-byte payload; semantics unresolved
        ...
        Server0x0939                    = 0x0939, // 0x18-byte payload; semantics unresolved
        ServerEntityPropertiesUpdate    = 0x093A,
        ServerUnitUpdateObjectiveIndex  = 0x093B,
        ServerEmote                     = 0x093C,
        Server0x093D                    = 0x093D, // 0x10-byte payload; semantics unresolved
        Server0x093E                    = 0x093E, // 0x10-byte payload; semantics unresolved
