namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ServerHousingResidenceKeyedUpdate = 0x00CA, // ulong + two uint32 fields; semantics unresolved
        ...
        Server0x019C                    = 0x019C, // 0x10-byte payload; semantics unresolved
        ...
        Server0x01A4                    = 0x01A4, // 0x14-byte payload; semantics unresolved
        ...
        ServerCREDDExchangeInfoResults  = 0x026A, // empty compatibility shape mapped; non-empty owned order rows still unresolved
        ...
        Server0x07CD                    = 0x07CD, // 0x28-byte payload; semantics unresolved
        ClientGenericMapNodeRequest     = 0x07CF, // GenericMapNodeChoose sends missing node id before local GenericFloater
        Server0x07D3                    = 0x07D3, // 0x10-byte payload; semantics unresolved
        ...
        ServerAccountUInt64Payload     = 0x0986, // uint64; consumer semantics unresolved
        ...
        ServerStorePurchaseOfferResult = 0x098C, // StorePurchaseOfferResult client event; server emit sites unresolved
        ServerStorePurchaseOfferResultVariant = 0x098D, // same consumer as 0x098C; opcode variant unresolved
        ServerStorePurchaseHistoryReady = 0x098E,
        ServerStoreCurrencyPackageRow  = 0x098F, // store currency-package shape; no store event consumer found
