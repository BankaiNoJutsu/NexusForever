namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        Server0x026A                    = 0x026A, // 0x50-byte payload; semantics unresolved
        ...
        Server0x0414                    = 0x0414, // 0x18-byte payload; semantics unresolved
        ...
        Server0x042A                    = 0x042A, // 0xC-byte payload; semantics unresolved
        ClientGroupLeave                = 0x042B,
        ServerGroupLeave                = 0x042D,
        ClientGroupLootRulesChange      = 0x042E,
        ServerGroupLootRulesChange      = 0x042F,
        Server0x0431                    = 0x0431, // 0x18-byte payload; semantics unresolved
        ClientGroupMarkUnit             = 0x0432,
        Server0x0436                    = 0x0436, // 0x60-byte payload; semantics unresolved
        ServerGroupMemberFlagsChanged   = 0x0437,
        Server0x0438                    = 0x0438, // 0x28-byte payload; semantics unresolved
        Server0x0441                    = 0x0441, // 0x38-byte payload; semantics unresolved
        ...
        Server0x0718                    = 0x0718, // 0x20-byte payload; semantics unresolved
        ...
        Server0x0969                   = 0x0969, // 0x10-byte payload; semantics unresolved
        Server0x096A                   = 0x096A, // 0x30-byte payload; semantics unresolved
        Server0x096B                   = 0x096B, // 0x10-byte payload; semantics unresolved
        Server0x096C                   = 0x096C, // 0x10-byte payload; semantics unresolved
        ServerAccountItems              = 0x096D,
        Server0x096E                   = 0x096E, // 0x1c-byte payload; semantics unresolved
        ServerAccountOperationResult    = 0x0970,
        Server0x0971                   = 0x0971, // 0x8-byte payload; semantics unresolved
        ...
        Server0x0976                   = 0x0976, // 0x60-byte payload; semantics unresolved
        Server0x0977                   = 0x0977, // 0x1-byte payload; semantics unresolved
        Server0x0978                   = 0x0978, // 0x10-byte payload; semantics unresolved
        ServerAccountItemsPending       = 0x0979,
        Server0x097A                   = 0x097A, // 0x10-byte payload; semantics unresolved
        Server0x097B                   = 0x097B, // 0x4-byte payload; semantics unresolved
        ServerAccountItemDelete         = 0x097C,
        Server0x097D                   = 0x097D, // 0x10-byte payload; semantics unresolved
        Server0x097E                   = 0x097E, // 0x10-byte payload; semantics unresolved
        ServerAccountTier               = 0x097F,
        Server0x0980                   = 0x0980, // 0x4-byte payload; semantics unresolved
        ...
        Server0x0986                   = 0x0986, // 0x8-byte payload; semantics unresolved
        ServerStoreFinalise             = 0x0987,
        ServerStoreCategories           = 0x0988,
        Server0x0989                   = 0x0989, // 0x1-byte payload; semantics unresolved
        Server0x098A                   = 0x098A, // 0x4-byte payload; semantics unresolved
        ServerStoreOffers               = 0x098B,
        Server0x098C                   = 0x098C, // 0x8-byte payload; semantics unresolved
        Server0x098D                   = 0x098D, // 0x8-byte payload; semantics unresolved
        Server0x098E                   = 0x098E, // 0x10-byte payload; semantics unresolved
        Server0x098F                   = 0x098F, // 0x20-byte payload; semantics unresolved
        Server0x0990                   = 0x0990, // 0x8-byte payload; semantics unresolved
        Server0x0991                   = 0x0991, // 0x60-byte payload; semantics unresolved
    }
}
