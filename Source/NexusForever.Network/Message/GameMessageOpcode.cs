namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        ServerGroupMemberRoleChange      = 0x0438, // 0x28-byte payload; mirrors ServerGroupMemberFlagsChanged layout.
        ...
        ServerGroupMemberDetailUpdate    = 0x0468, // 0x28-byte payload; compact member detail refresh (prefix of FUN_140607490 layout).
        ...
        ServerMatchingManagerFlag       = 0x05B0, // matching manager state packet with one boolean flag; no runtime sender/consumer or direct client opcode evidence yet
        ...
        ClientMatchingGameReadyResponse = 0x05C8, // one-bit join-or-decline response to an active match proposal
        ...
        ServerSpellThresholdClear       = 0x0814, // Spell4 id plus one flag; consumer SpellThreshold_HandleClear @ 1403bed60
        ServerSpellThresholdSpell4      = 0x0815, // single Spell4 id; consumer SpellThreshold_HandleClear @ 1403bed60
        ServerSpellThresholdStart       = 0x0816, // three Spell4 ids plus casting id; consumer SpellThreshold_HandleStart @ 1403be940
        ServerSpellThresholdUpdate      = 0x0817, // Spell4 id plus threshold stage byte; consumer SpellThreshold_HandleUpdate @ 1403bea90
        ServerSpellWrapperTierEntry     = 0x0818, // slot/index plus spell-list tier entry; wrapper tier-entry apply path @ 1403ee403
        ServerSpellWrapperNodeRemove    = 0x0819, // node entity id plus spell-wrapper id; wrapper prune path @ 1403ee3af
