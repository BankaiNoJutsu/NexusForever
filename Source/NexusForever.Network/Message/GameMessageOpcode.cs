namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        Server07F5                      = 0x07F5, // spell broadcast family: opaque follow-up after 0x07F4/0x07FF
        Server07F6                      = 0x07F6, // spell broadcast family: opaque follow-up after 0x07F4/0x07FF
        Server07F7                      = 0x07F7, // spell broadcast family: opaque follow-up after 0x07F4/0x07FF
        Server07F8                      = 0x07F8, // spell broadcast family: nested effect follow-up, payload still unnamed
        Server07F9                      = 0x07F9, // spell broadcast family: live cast cancel notification
        Server07FA                      = 0x07FA, // spell broadcast family: opaque follow-up after 0x07F4/0x07FF
        Server07FB                      = 0x07FB, // spell broadcast family: likely miss or immunity target report
        ServerSpellCastResult           = 0x07FC,
        Server07FD                      = 0x07FD, // spell broadcast family: position or telegraph sync follow-up
        ServerSpellFinish               = 0x07FE,
        ServerSpellStart                = 0x07FF,
        ClientSpellStopCast             = 0x0801,
        ClientCancelEffect              = 0x0802,
        ServerCooldown                  = 0x0804,
        Server0811                      = 0x0811, // spell broadcast family: likely partial target list or 0x07FF subset
        ServerSpellBuffRemove           = 0x0813,
        Server0814                      = 0x0814, // spell broadcast family: opaque spell trigger or follow-up flag
        Server0816                      = 0x0816, // spell broadcast family: root or parent spell hierarchy follow-up
        Server0817                      = 0x0817, // spell broadcast family: opaque spell event byte
        Server0818                      = 0x0818, // spell broadcast family: target-info follow-up seen near telegraph buffs
