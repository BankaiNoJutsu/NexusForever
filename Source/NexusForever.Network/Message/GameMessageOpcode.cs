namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        Server0x00CB                    = 0x00CB, // empty payload; semantics unresolved
        Server0x00CC                    = 0x00CC, // 15-bit scalar payload; semantics unresolved
        Server0x00CD                    = 0x00CD, // 15-bit scalar payload; semantics unresolved
        Server0x00CE                    = 0x00CE, // wide string payload; semantics unresolved
        Server0x00D1                    = 0x00D1, // empty payload; semantics unresolved
        ...
        Server0x010D                    = 0x010D, // empty payload; semantics unresolved
        ServerHousingBasics             = 0x010E,
        Server0x0110                    = 0x0110, // uint32 + 18-bit scalar + uint32 + 8-bit scalar; semantics unresolved
        ...
        Server0x019A                    = 0x019A, // 0x8-byte payload; semantics unresolved
        ...
        Server0x01A6                    = 0x01A6, // 0x4-byte payload; semantics unresolved
        Server0x01A7                    = 0x01A7, // 0x10-byte payload; semantics unresolved
        Server0x01A8                    = 0x01A8, // 0x10-byte payload; semantics unresolved
        Server0x01A9                    = 0x01A9, // 0x8-byte payload; semantics unresolved
        ...
        Server0x01B2                    = 0x01B2, // 0x10-byte payload; semantics unresolved
        ServerResurrectionShow          = 0x01B3,
        ServerZoneMap                   = 0x01B4,
        ServerChatAction                = 0x01B5,
        ServerChatFlag                  = 0x01B7,
        Server0x01B8                    = 0x01B8, // 0x68-byte payload; semantics unresolved
        ...
        Server0x01C1                    = 0x01C1, // 0x20-byte payload; semantics unresolved
        ServerChatAccept                = 0x01C2,
        ClientChat                      = 0x01C3,
        Server0x01C4                    = 0x01C4, // 0x20-byte payload; semantics unresolved
        ...
        Server0x01EF                    = 0x01EF, // 0x10-byte payload; semantics unresolved
        ...
        Server0x025F                    = 0x025F, // scalar/triple/scalar/triple/scalar payload; semantics unresolved
        Server0x0260                    = 0x0260, // counted Server0x025F-row list; semantics unresolved
        Server0x0261                    = 0x0261, // counted Server0x0263-row list; semantics unresolved
        ServerEntityCreate              = 0x0262,
        Server0x0263                    = 0x0263, // uint32/uint32/17-bit triple/uint32/uint32-triple payload; semantics unresolved
        Server0x0264                    = 0x0264, // scalar header plus counted uint32 list; semantics unresolved
        ...
        Server0x0347                    = 0x0347, // 0x10-byte payload; semantics unresolved
        Server0x0348                    = 0x0348, // 0x30-byte payload; semantics unresolved
        Server0x034C                    = 0x034C, // 0x1C-byte payload; semantics unresolved
        Server0x034D                    = 0x034D, // 0x40-byte payload; semantics unresolved
        Server0x034E                    = 0x034E, // 0x28-byte payload; semantics unresolved
        Server0x0351                    = 0x0351, // 0x20-byte payload; semantics unresolved
        ...
        ClientEmote                     = 0x037E,
        Server0x037F                    = 0x037F, // 0x18-byte payload; semantics unresolved
        ...
        Server0x03EF                    = 0x03EF, // 0x10-byte payload; semantics unresolved
        ...
        ServerGroupKickResult            = 0x042A, // 0xC-byte payload; response to ClientGroupKick (0x0428). Field layout needs Ghidra verification.
        ClientGroupLeave                = 0x042B,
        ServerGroupLeave                = 0x042D,
        ClientGroupLootRulesChange      = 0x042E,
        ServerGroupLootRulesChange      = 0x042F,
        ServerGroupLootRuleValidationResult = 0x0431, // 0x18-byte payload; after ServerGroupLootRulesChange (0x042F). Field layout needs Ghidra verification.
        ClientGroupMarkUnit             = 0x0432,
        ServerGroupRosterUpdate          = 0x0436, // 0x60-byte payload; full group member list. Field layout needs Ghidra verification.
        ServerGroupMemberFlagsChanged   = 0x0437,
        ServerGroupMemberRoleChange      = 0x0438, // 0x28-byte payload; after ServerGroupMemberFlagsChanged (0x0437). Field layout needs Ghidra verification.
        ServerGroupReadyCheckStatusUpdate = 0x0441, // 0x38-byte payload; ready check status broadcast. Field layout needs Ghidra verification.
        ...
        ServerGroupRequestJoinWindow     = 0x045A, // 0x20-byte payload; join request dialog for leader. Field layout needs Ghidra verification.
        ServerGroupMarkUnit             = 0x045B,
        ClientQuestShareResult          = 0x045E,
        ClientQuestShare                = 0x045F,
        ServerQuestShareResult           = 0x0461, // 0x10-byte payload; quest share result between ClientQuestShare (0x045F) and ServerGroupMaxSizeChange (0x0462). Field layout needs Ghidra verification.
        ServerGroupMaxSizeChange        = 0x0462,
        ServerGroupMemberStatUpdate     = 0x0466,
        ServerGroupUpdatePlayerRealm    = 0x0467,
        ServerGroupMemberDetailUpdate    = 0x0468, // 0x28-byte payload; between ServerGroupUpdatePlayerRealm (0x0467) and ServerGroupPositionUpdate (0x0469). Field layout needs Ghidra verification.
        ...
        Server0x0567                    = 0x0567, // 0x10-byte payload; semantics unresolved
        ServerItemSwap                  = 0x0568,
        ServerItemMove                  = 0x0569,
        ServerItemError                 = 0x056A,
        Server0x056B                    = 0x056B, // 0x20-byte payload; semantics unresolved
        Server0x056C                    = 0x056C, // 0x28-byte payload; semantics unresolved
        Server0x056D                    = 0x056D, // 0x18-byte payload; semantics unresolved
        ...
        Server0x05A1                    = 0x05A1, // 0x10-byte payload; semantics unresolved
        ...
        Server0x06DF                    = 0x06DF, // 0x20-byte payload; semantics unresolved
        ...
        Server0x06F7                    = 0x06F7, // 0x8-byte payload; semantics unresolved
        ...
        ServerRaidQueueStatus            = 0x0718, // 0x20-byte payload; between ServerQueueStatus (0x0717) and ClientRaidInfoRequest (0x0719). Field layout needs Ghidra verification.
        ...
        Server0x074A                    = 0x074A, // 0x18-byte payload; semantics unresolved
        ...
        Server0x077E                    = 0x077E, // 0x10-byte payload via ServerFlightPathUpdate_ReadPayload; semantics unresolved
        ...
        ClientAccountRedeemCoupon       = 0x0790, // wide-string coupon; client sender still unlabeled in exports
        ...
        Server0x07D5                    = 0x07D5, // 0x14-byte payload; semantics unresolved
        ...
        ServerSpellTriggerFlag          = 0x0814, // Spell4 id plus one trigger flag
        ServerSpell0815                 = 0x0815, // spell follow-up carrying one Spell4 id; semantics unresolved
        ServerSpellHierarchy            = 0x0816, // root, parent, current Spell4 ids plus casting id
        ServerSpellEventByte            = 0x0817, // Spell4 id plus one event byte
        ServerSpellTargetInfo           = 0x0818, // leading uint plus spell-list tier entry; semantics unresolved
        ...
        Server0x0846                    = 0x0846, // 0x4-byte payload; semantics unresolved
        ServerMapTrackedUnitDisable     = 0x0848,
        ServerMapTrackedUnitUpdate      = 0x0849,
        ClientCraftingAdditive          = 0x084A,
        Server0x084B                    = 0x084B, // 0x18-byte payload; semantics unresolved
        ...
        Server0x0855                    = 0x0855, // 0xC-byte payload; semantics unresolved
        ...
        Server0x0889                    = 0x0889, // three uint32 fields; semantics unresolved
        ...
        Server0x08CC                    = 0x08CC, // uint32 plus wide string; semantics unresolved
        ServerUnitSetChair              = 0x08CF,
        ServerReputationOverrideAdd     = 0x08D7,
        Server0x08F4                    = 0x08F4, // uint32, 5-bit value, uint32; semantics unresolved
        ...
        Server0x0939                    = 0x0939, // uint32, 14-bit value, 18-bit value, wide string; semantics unresolved
        ServerEntityPropertiesUpdate    = 0x093A,
        ServerUnitUpdateObjectiveIndex  = 0x093B,
        ServerEmote                     = 0x093C,
        Server0x093D                    = 0x093D, // uint32, 5-bit value, two uint32 fields; semantics unresolved
        Server0x093E                    = 0x093E, // two uint32 fields plus uint64; semantics unresolved
        ...
        ServerAccountItemCacheAdd      = 0x096A, // leading uint32 unresolved
        ServerAccountItemCacheListAppend = 0x096B, // leading uint32 unresolved
        ServerAccountItemCacheRemove   = 0x096C, // leading uint32 unresolved
        ...
        ServerCREDDExchangeOrderCacheRows = 0x097A, // internal cache rows; field semantics unresolved
        ...
        ServerStorePurchaseOfferResult = 0x098C, // character purchase success (paired client 0x082A)
        ServerStorePurchaseOfferResultVariant = 0x098D, // account purchase success (paired client 0x0828)
