namespace NexusForever.Network.Message
{
    public enum GameMessageOpcode
    {
        ...
        Server0x04FE                    = 0x04FE, // 0x18-byte payload; semantics unresolved
        Server0x0501                    = 0x0501, // 0x30-byte payload; semantics unresolved
        Server0x0506                    = 0x0506, // 0x10-byte payload; semantics unresolved
        ...
        Server0x0514                    = 0x0514, // 0x18-byte payload; semantics unresolved
        ClientHousingNeighborEvict      = 0x0515,
        Server0x0516                    = 0x0516, // 0x30-byte payload; semantics unresolved
        ClientHousingNeighborSetPermission = 0x0518,
        Server0x0519                    = 0x0519, // 0x30-byte payload; semantics unresolved
        Server0x051F                    = 0x051F, // 0x18-byte payload; semantics unresolved
        ...
        Server0x053A                    = 0x053A, // 0x20-byte payload; semantics unresolved
        Server0x053B                    = 0x053B, // 0x20-byte payload; semantics unresolved
        ...
        Server0x078C                    = 0x078C, // 0x10-byte payload; semantics unresolved
        ...
        Server0x080F                    = 0x080F, // 0x10-byte payload; semantics unresolved
        Server0x0810                    = 0x0810, // 0x10-byte payload; semantics unresolved
        ServerSpellCastTargetList       = 0x0811, // spell broadcast casting-id target list
        Server0x0812                    = 0x0812, // 0x10-byte payload; semantics unresolved
        ...
        Server0x0986                   = 0x0986, // uint64; semantics unresolved
        ...
        Server0x098C                   = 0x098C, // flag + 5-bit field; client dispatches StorePurchaseOfferResult, variant unresolved
        Server0x098D                   = 0x098D, // flag + 5-bit field; client dispatches StorePurchaseOfferResult, variant unresolved
        ServerStorePurchaseHistoryReady = 0x098E,
        Server0x098F                   = 0x098F, // store currency-package shape; no store event consumer found
