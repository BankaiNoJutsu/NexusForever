...
{
    /// <inheritdoc />
    public partial class FriendshipSqliteInitial : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    blockAccountFriendRequests = table.Column<bool>(type: "INTEGER", nullable: false),
                    invitePrivilegesSuspended = table.Column<bool>(type: "INTEGER", nullable: false),
                    activeCharacterId = table.Column<ulong>(type: "INTEGER", nullable: true),
                    activeRealmId = table.Column<ushort>(type: "INTEGER", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<ulong>(type: "INTEGER", nullable: false)
                        .Annotation("Sqlite:Autoincrement", true),
                    inviterAccountId = table.Column<uint>(type: "INTEGER", nullable: false),
                    inviteeAccountId = table.Column<uint>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    friendCharacterId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    friendRealmId = table.Column<ushort>(type: "INTEGER", nullable: false),
                    note = table.Column<string>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    accountId = table.Column<uint>(type: "INTEGER", nullable: false),
                    friendAccountId = table.Column<ulong>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    accountId = table.Column<uint>(type: "INTEGER", nullable: false),
                    friendAccountInviteId = table.Column<ulong>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_account_friend_invite_friendship_account_invite_friendAccountInviteId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_account_friend_invite_pending_friendship_account_invite_friendAccountInviteId",
                        column: x => x.friendAccountInviteId,
                        principalTable: "friendship_account_invite",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    characterId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    realmId = table.Column<ushort>(type: "INTEGER", nullable: false),
                    friendId = table.Column<ulong>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    characterId = table.Column<ulong>(type: "INTEGER", nullable: false),
                    realmId = table.Column<ushort>(type: "INTEGER", nullable: false),
                    friendInviteId = table.Column<ulong>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_character_friend_invite_pending_friendship_invite_friendInviteId",
                        column: x => x.friendInviteId,
                        principalTable: "friendship_invite",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_friendship_inviterCharacterId_inviterRealmId_friendCharacterId_friendRealmId",
                table: "friendship",
