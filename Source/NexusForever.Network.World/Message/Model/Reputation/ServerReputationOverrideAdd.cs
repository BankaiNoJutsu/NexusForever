...
{
    // For temporarily overriding a player's reputation amount for a specific faction.
    // Does not affect the underlying reputation state or the delta sent in ServerReputationUpdate.
