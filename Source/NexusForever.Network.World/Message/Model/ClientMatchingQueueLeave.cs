...
{
    /// <summary>
    /// Opcode 0x05B5. Native client registration binds this request to shared local writer slot
    /// <c>LAB_14008a150</c> and reader slot <c>LAB_14008a140</c> with registered size <c>4</c>, the same
    /// 4-byte structural slot reused by opcode <c>0x05B6</c> and unresolved opcode <c>0x00C8</c>.
