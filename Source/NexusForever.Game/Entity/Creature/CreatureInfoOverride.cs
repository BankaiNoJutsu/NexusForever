...
namespace NexusForever.Game.Entity.Creature
{
    public class CreatureInfoOverride : ICreatureInfoOverride
    {
        ...
        {
            baseCreatureInfo = creatureInfo ?? throw new ArgumentNullException(nameof(creatureInfo));
            return this;
        }
        ...
        {
            return level ?? baseCreatureInfo.GetLevel();
        }
        ...
        {
            return displayInfoEntry ?? baseCreatureInfo.GetDisplayInfoEntry();
        }
        ...
        {
            return outfitInfoEntry ?? baseCreatureInfo.GetOutfitInfoEntry();
        }
    }
}
