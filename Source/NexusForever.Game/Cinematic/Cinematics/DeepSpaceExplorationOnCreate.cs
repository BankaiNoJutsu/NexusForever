...
{
    public class DeepSpaceExplorationOnCreate : CinematicBase, IDeepSpaceExplorationOnCreate
    {
        protected override void Setup()
        {
            // WIP-guessed from LaughingWS Instances-and-more: the branch queues a
            // Deep Space on-create cinematic through this interface, but supplies
