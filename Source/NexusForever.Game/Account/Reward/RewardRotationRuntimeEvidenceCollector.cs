            ...
            return new RewardRotationRuntimeEvidenceRecord
            {
                ...
                EntryStateRowProtocol = new RewardRotationRowProtocol
                {
                    ...
                    [
                        ...
                        "Entry-state State and Value semantics remain live-evidence blocked."
                    ]
                },
                ...
                [
                    CreatePacketTemplateReference(
                        ...
                        "Shape-only delta template; zeroed payload is diagnostic only and is not enqueued."),
                    CreatePacketTemplateReference(
                ...
                [
                    ...
                    "Reward rotation schedule rows and entry-state semantics remain blocked on future live capture or stronger reverse-engineering evidence.",
                    "No live schedule rows or entry-state transitions are generated by this tooling."
                ],
                Notes =
                [
