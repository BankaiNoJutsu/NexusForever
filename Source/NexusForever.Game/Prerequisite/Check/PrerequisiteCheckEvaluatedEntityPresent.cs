...
namespace NexusForever.Game.Prerequisite.Check
{
    ...
    /// <c>value0</c> is ignored. Retail row <c>44550</c> is a target-apply gate on Engineer Portable Black Hole.
    /// </summary>
    [PrerequisiteCheck(PrerequisiteType.EvaluatedEntityPresent)]
    public class PrerequisiteCheckEvaluatedEntityPresent : IPrerequisiteCheck
    {
