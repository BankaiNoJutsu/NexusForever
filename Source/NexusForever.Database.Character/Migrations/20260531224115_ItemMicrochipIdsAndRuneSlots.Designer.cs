...
namespace NexusForever.Database.Character.Migrations
{
    ...
    [Migration("20260531224115_ItemMicrochipIdsAndRuneSlots")]
    partial class ItemMicrochipIdsAndRuneSlots
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterChallengeModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
                    ...
                    b.Property<double>("ActiveTimerSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(0.0)
                        .HasColumnName("activeTimerSeconds");

                    b.Property<double>("AreaFailTimerSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(0.0)
                    ...
                    b.Property<double>("CooldownTimerSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("double")
                        .HasDefaultValue(0.0)
                    ...
                    b.Property<bool>("LeftArea")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("leftArea");

                    b.Property<bool>("OnCooldown")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("tinyint(1)")
                        .HasDefaultValue(false)
                        .HasColumnName("onCooldown");

                    b.HasKey("Id", "ChallengeId")
                        .HasName("PRIMARY");

                    b.ToTable("character_challenge", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterGalacticArchiveModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
                    ...
                    b.HasKey("Id", "ArchiveArticleId")
                        .HasName("PRIMARY");

                    b.ToTable("character_galactic_archive", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterMatchingPenaltyModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
                    ...
                    b.ToTable("character_matching_penalty", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterSchematicModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
                    ...
                    b.Property<float>("DiscoveryCoordinateX")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
                        .HasDefaultValue(0f)
                        .HasColumnName("discoveryCoordinateX");

                    b.Property<float>("DiscoveryCoordinateY")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("float")
                        .HasDefaultValue(0f)
                        .HasColumnName("discoveryCoordinateY");

                    b.HasKey("Id", "TradeskillSchematic2Id")
                        .HasName("PRIMARY");

                    b.ToTable("character_schematic", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterTradeskillModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
                    ...
                    b.HasKey("Id", "TradeskillId")
                        .HasName("PRIMARY");

                    b.ToTable("character_tradeskill", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.LeaderboardPveScoreModel", b =>
                {
                    ...
                    b.ToTable("leaderboard_pve_score", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.LeaderboardPvpScoreModel", b =>
                {
                    ...
                    b.ToTable("leaderboard_pvp_score", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.RealmBankItemModel", b =>
                {
                    b.Property<ulong>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint(20) unsigned")
                    ...
                    b.ToTable("realm_bank_item", (string)null);
                });
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.ResidenceNeighborModel", b =>
                {
                    ...
                    b.HasKey("ResidenceId", "NeighborCharacterId")
                        .HasName("PRIMARY");
            ...
            modelBuilder.Entity("NexusForever.Database.Character.Model.CharacterMatchingPenaltyModel", b =>
                {
                    b.HasOne("NexusForever.Database.Character.Model.CharacterModel", "Character")
                        .WithOne("MatchingPenalty")
                        .HasForeignKey("NexusForever.Database.Character.Model.CharacterMatchingPenaltyModel", "Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
