...
namespace NexusForever.Script.Main.Tutorial
{
    ...
    public class TutorialMapScript : IMapScript, IOwnedScript<IBaseMap>
    {
        ...
        private void EnsureExileCombatSimulationEntities()
        {
            ...
            log.LogDebug("Spawned Rider's Reef Exile final combat wave on map {MapId}: world location {WorldLocationId}, legionnaires=3.",
                owner.Entry.Id,
                ExileCombatFinalWorldLocationId);
        }
        ...
        private void EnsureDominionCombatSimulationEntities()
        {
            ...
            SpawnTutorialEntity<IAiTurretEntity>(74862u, ToVector3(turret00));
            SpawnTutorialEntity<IAiTurretEntity>(74862u, ToVector3(turret01));
