...
namespace NexusForever.Script.Main.Quests.Tutorial
{
    ...
    public class Q10519PreparingForDepartureQuestScript : IQuestScript, IOwnedScript<IQuest>
    {
        private const ushort NextQuestId = 10520;

        private readonly ILogger<Q10519PreparingForDepartureQuestScript> log;
