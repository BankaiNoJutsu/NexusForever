...
namespace NexusForever.Script.Main.Quests.Tutorial
{
    ...
    public class Q10520ShipInteriorQuestScript : IQuestScript, IOwnedScript<IQuest>
    {
        private const ushort NextQuestId = 10528;

        private readonly ILogger<Q10520ShipInteriorQuestScript> log;
