...
public class ActivationInteractionGuardsTests
{
    ...
    [Fact]
    public void TryRejectOutOfRangeTarget_WithImplicitClientFallbackAtDodgerEdge_DoesNotReject()
    {
        IWorldSession session = RecordingDispatchProxy<IWorldSession>.Create(out RecordingDispatchProxy<IWorldSession> sessionProxy);
        IPlayer player = RecordingDispatchProxy<IPlayer>.Create(out RecordingDispatchProxy<IPlayer> playerProxy);
        IWorldEntity entity = RecordingDispatchProxy<IWorldEntity>.Create(out RecordingDispatchProxy<IWorldEntity> entityProxy);
        ...
        entityProxy.SetProperty(nameof(IGridEntity.Position), new Vector3(10.75f, 0f, 0f));
        entityProxy.SetProperty(nameof(IWorldEntity.CreatureEntry), new Creature2Entry
        {
    ...
    [Fact]
    public void TryRejectOutOfRangeTarget_WithImplicitClientFallbackBeyondEffectiveRange_Rejects()
    {
        IWorldSession session = RecordingDispatchProxy<IWorldSession>.Create(out RecordingDispatchProxy<IWorldSession> sessionProxy);
        IPlayer player = RecordingDispatchProxy<IPlayer>.Create(out RecordingDispatchProxy<IPlayer> playerProxy);
        IWorldEntity entity = RecordingDispatchProxy<IWorldEntity>.Create(out RecordingDispatchProxy<IWorldEntity> entityProxy);
        ...
        entityProxy.SetProperty(nameof(IGridEntity.Position), new Vector3(11.1f, 0f, 0f));
        entityProxy.SetProperty(nameof(IWorldEntity.CreatureEntry), new Creature2Entry
        {
            ActivateSpellMinRange = 0f,
            ActivateSpellMaxRange = 0f,
