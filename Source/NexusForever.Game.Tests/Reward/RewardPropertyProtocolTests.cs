...
public class RewardPropertyProtocolTests
{
    ...
    public void ServerPremiumRewards_WritesModifierSpecificValueEncodings()
    {
        var packet = new ServerPremiumRewards
        {
            Properties =
            {
                new ServerPremiumRewards.RewardProperty
                {
                    ...
                    Data = 0x10203040u,
                    ModifierType = RewardModifierValueType.AdditiveScalar,
                    Value = 1.5f,
                    OwnerMultipliers =
                    {
                        new ServerPremiumRewards.RewardProperty.RewardOwnerMultiplier
                        {
                            ...
                            OwnerId = 0x01020304u,
                            ModifierType = RewardModifierValueType.MultiplicativeScalar,
                            Value = 2.5f
                        }
                    }
                },
                new ServerPremiumRewards.RewardProperty
                {
                    ...
                    Data = 0x50607080u,
                    ModifierType = RewardModifierValueType.Discrete,
                    Value = 12f
                },
                new ServerPremiumRewards.RewardProperty
                {
        ...
        Assert.Equal(RewardModifierValueType.AdditiveScalar, reader.ReadEnum<RewardModifierValueType>(2u));
        ...
        Assert.Equal(RewardModifierValueType.MultiplicativeScalar, reader.ReadEnum<RewardModifierValueType>(2u));
        ...
        Assert.Equal(RewardModifierValueType.Discrete, reader.ReadEnum<RewardModifierValueType>(2u));
