namespace NexusForever.Game.Static.Quest
{
    ...
    public enum QuestObjectiveType
    {
        ...
        Unknown20                    = 20, // data = PublicEventObjectiveId, ObjectiveText describes completing a cooking recipe (Count: 11)
        ...
        Unknown28                    = 28, // data = PublicEventObjectiveId, ObjectiveText describes rescuing creatures (Count: 5)
        Unknown29                    = 29, // data = unknown, ObjectiveText not in localisation files (Count: 2)
        Unknown31                    = 31, // data = PublicEventObjectiveId, ObjectiveText are all empty (Count: 260)
