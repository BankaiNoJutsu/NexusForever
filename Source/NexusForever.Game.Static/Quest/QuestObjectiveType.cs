namespace NexusForever.Game.Static.Quest
{
    ...
    public enum QuestObjectiveType
    {
        ...
        KillNamedCreature            = 15, // data = CreatureId, ObjectiveText describes killing a single or number of named creatures (Count: 26)
        ...
        CompletePublicEventRecipe    = 20, // data = PublicEventObjectiveId, ObjectiveText describes completing a cooking recipe (Count: 11)
        ...
        CompleteEvent                = 25, // data = PublicEventObjectiveId, ObjectiveText describes completing a mini event (killing a bunch of zombies like in http://wildstar.mmorpg-life.com/quests/here-they-come-exile/) (Count: 152)
        Unknown27                    = 27, // data = unknown, ObjectiveText not in localisation files (Count: 1)
        RescuePublicEventCreatures   = 28, // data = PublicEventObjectiveId, ObjectiveText describes rescuing creatures (Count: 5)
        Unknown29                    = 29, // data = unknown, ObjectiveText not in localisation files (Count: 2)
        CompletePublicEventObjective = 31, // data = PublicEventObjectiveId, ObjectiveText are all empty (Count: 260)
        ...
        CompleteMaxLevelQuests       = 39, // data = 0 on all entries, ObjectiveText/owning quest titles describe completing max-level quests, including episodic, daily, and level-50 quest bonuses (Count: 2)
        ParticipateInGroupContent    = 40, // data = activity category, ObjectiveText/owning quest titles describe weekly group PvE or PvP bonus participation via dungeons, adventures, battlegrounds, and arenas (Count: 2)
        ...
        CombatMomentum               = 44, // data = PublicEventObjectiveId, ObjectiveText describes completing an amount of combat momentum actions (Count: 7)
