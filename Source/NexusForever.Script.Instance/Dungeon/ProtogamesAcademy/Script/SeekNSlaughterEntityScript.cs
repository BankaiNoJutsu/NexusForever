...
namespace NexusForever.Script.Instance.Dungeon.ProtogamesAcademy.Script
{
    ...
    /// </summary>
    [ScriptFilterScriptName("SeekNSlaughterEntityScript")]
    public class SeekNSlaughterEntityScript : PublicEventObjectiveCreditEntityScript
    {
        public SeekNSlaughterEntityScript(
            IFactory<ISpellParameters> spellParametersFactory,
            IGameTableManager gameTableManager)
            : base(spellParametersFactory, gameTableManager, (uint)PublicEventObjective.DefeatSeekNSlaughter)
        {
        }
    }
}
