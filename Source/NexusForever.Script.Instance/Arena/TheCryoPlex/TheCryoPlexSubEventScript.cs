...
{
    /// <summary>
    /// WIP-guessed from LaughingWS Instances-and-more: the sub-event mirrors the
    /// branch's preparation-to-fight handoff, while round objectives remain blocked.
    /// </summary>
    [ScriptFilterOwnerId(582)]
    public class TheCryoPlexSubEventScript : IPublicEventScript, IOwnedScript<IPublicEvent>
    {
